...
import { ArrowLeft, PawPrint, Send, Phone, User, Info, Heart, Home as HomeIcon, HeartHandshake } from 'lucide-react';
...
export default function CreatePetPage() {
  ...
  const validate = (): boolean => {
    ...
    if (!form.name.trim()) {
      newErrors.name = t('create.nameError');
    } else if (form.name.trim().length > 60) {
      newErrors.name = t('create.nameLong');
    }
    if (!form.species) {
      newErrors.species = t('create.speciesError');
    }
    if (!imageFile) {
      newErrors.image = t('create.photoError');
    }
    ...
    if (form.ownerName.trim() && !hasContact) {
      newErrors.ownerPhone = t('create.phoneRequired');
    }
    if (hasContact && !form.ownerName.trim()) {
      newErrors.ownerName = t('create.nameRequired');
    }
    setErrors(newErrors);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setUploadPhase(t('create.uploading'));
        ...
        <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-14">
          ...
          >
            ...
            <div>
              ...
              />
              {errors.name && (
                <p className="mt-1.5 font-body text-sm text-error-500">{errors.name}</p>
              )}
            </div>
            ...
            <div>
              ...
              {errors.species && (
                <p className="mt-1.5 font-body text-sm text-error-500">{errors.species}</p>
              )}
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="breed" className="label-text">
                  {t('create.breed')}
                </label>
                <input
                  id="breed"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <label htmlFor="color" className="label-text">
                  {t('create.color')}
                </label>
                <input
                  id="color"
            ...
            {/* Personality */}
            <div>
              <label htmlFor="personality" className="label-text">
            ...
            <div className="rounded-3xl border-2 border-ocean-100 bg-ocean-50/50 p-5">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {errors.ownerName && (
                    <p className="mt-1.5 font-body text-sm text-error-500">{errors.ownerName}</p>
                  )}
                </div>

                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    <label htmlFor="ownerPhone" className="label-text">
                    ...
                    {errors.ownerPhone && (
                      <p className="mt-1.5 font-body text-sm text-error-500">{errors.ownerPhone}</p>
                    )}
                  </div>
                  <div>
                    <label htmlFor="ownerWhatsapp" className="label-text">
                      {t('create.whatsapp')}
                    </label>
                    <div className="relative">
                      <svg
            ...
            <div className="space-y-4 rounded-3xl border-2 border-ocean-100 bg-ocean-50/30 p-5">
              ...
              {form.isAvailableForMating && (
                ...
                >
                  ...
                  <div>
                    <label htmlFor="vaccinationStatus" className="label-text">
                      {t('create.vaccination')}
                    </label>
                    <input
            ...
            <div className="pt-2">
              ...
              >
                {isSubmitting ? (
                  <>
                    ...
                    <span>{uploadPhase || t('create.creating')}</span>
                  </>
                ) : (
                  <>
              ...
              {isSubmitting && (
                <p className="mt-3 text-center font-body text-sm text-gray-400">
                  {t('create.waitMsg')}
                </p>
              )}
            </div>
